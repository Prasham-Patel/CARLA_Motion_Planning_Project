...
if __name__ == '__main__':
    ...
    for i in range(len(path_x) - 1):
        ...
        # print(loc_x, loc_y)
        # print(w_x2, w_y2)
        while ((wheel_F_x - w_x2) ** 2 + (wheel_F_y - w_y2) ** 2) ** 0.5 >= 1:

            control = controller.run_step(5)
            ...
            # TRY THIS NEXT
            print("earlier", math.atan2((w_y2 - w_y), (w_x2 - w_x)))
            # print("next", math.atan2((-wheel_F_y + w_y2), (-wheel_F_x + w_x2)))
            trans = CARLA_world.ego_vehicle.get_transform()
            ...
            # control.steer = (-math.atan2(kp * d, ks + v) + new_phi)
            control.steer = phi/(math.pi/2)
